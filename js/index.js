...
function updateCard(card, data) {
    ...
    list.append(createLi(`Sunrise: ${(0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date((0,date_fns_fromUnixTime__WEBPACK_IMPORTED_MODULE_1__["default"])(data.sunrise)), 'HH:mm')}`));
    list.append(createLi(`Sunset: ${(0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date((0,date_fns_fromUnixTime__WEBPACK_IMPORTED_MODULE_1__["default"])(data.sunset)), 'HH:mm')}`));
}
...
async function init() {
    let weatherData;
    try {
        weatherData = await (0,_api__WEBPACK_IMPORTED_MODULE_0__.getWeatherData)('tainan');
    } catch (error) {
        console.error(error);
        return;
    }

    (0,_utils__WEBPACK_IMPORTED_MODULE_1__.updateCard)(todayCard, weatherData.today);
    (0,_utils__WEBPACK_IMPORTED_MODULE_1__.updateCard)(tomorrowCard, weatherData.tomorrow);
}
...
form.addEventListener('submit', async event => {
    ...
    let weatherData;
    try {
        weatherData = await (0,_api__WEBPACK_IMPORTED_MODULE_0__.getWeatherData)(city);
    } catch (error) {
        console.error(error);
        return;
    }
...
sectionDay.addEventListener('animationiteration', event => {
    ...
    if (bigFlag) {
        ...
        (0,_utils__WEBPACK_IMPORTED_MODULE_1__.toggleBtn)(targetBtn);
    }
});
